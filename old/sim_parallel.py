                def sim_parallel_update(tstep):
                    '''Function to get update position of agents in parallel.'''

                    # Shuffle the order of the agents around
                    removal = []
                    
                    self.K_edges = [self.density(this_edge) for this_edge in range(self.h.nedges)]
                    ...
                    for this_agent in self.S:
                        ...
                        this_density = self.K_edges[this_edge]
